...
<html lang="en">
<%
    System.out.println("-------------Connect agreement.jsp------------ ");
%>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>회원약관페이지(agreement.jsp)</title>
    <link href="style.css" rel="stylesheet" type="text/css">
</head>
<body style="text-align:center">
<h2>회원 동의 약관</h2><!--행이 20줄 폭 80-->
<textarea name="agree"  cols="80" rows="20">
            제 1 조 (약관의 적용)
...
<!-- <a href="register.html">동의</a>-->
<!-- document.location='이동할 페이지명'-->
<!-- history.back() 이전 페이지로 이동 -->
<input type="button" value="동의함" onclick="document.location='register.jsp'">
<input type="button" value="동의하지 않음" onclick="history.back()"><!--뒤로 이동-->
</body>
</html>